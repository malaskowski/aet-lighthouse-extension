...
public @interface LighthouseCollectorFactoryConf {

  @AttributeDefinition(
      name = "Lighthouse server uri",
      description = "Address of the Lighthouse server that will be used to gather the data.",
      type = AttributeType.STRING)
  String lighthouseInstanceUri() default "";
